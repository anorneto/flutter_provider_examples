...
class WondersProvider with ChangeNotifier {
  ...
  get path => wondersList[_index].path;
...
class Wonder {
  ...
  Wonder({@required this.name, @required this.description, @required this.location, @required this.year}) {
